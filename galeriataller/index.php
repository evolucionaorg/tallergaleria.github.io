...
<body>
  <div class="container">
    <div class="row">
       <div class="col-lg-4">
         <h1 class="text-primary">Taller</h1>
         <form action="Backend/subir.php" method="post" enctype="multipart/form-data">
         
          <div class="form-group">
              <label for="my-input">Ingrese un titulo para la imagen</label>
    ...
    <span aria-hidden="true">&times;</span>
          ...
          <?php session_unset(); } ?>
          <input type="submit" value="Subir" class="btn btn-primary" name="Subir">
         </form>
       </div>
       <div class="col-lg-8">
